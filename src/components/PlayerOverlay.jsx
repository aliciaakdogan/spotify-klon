...
export default function PlayerOverlay({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 left-1/2 max-w-[38ch] -translate-x-1/2 truncate text-lg font-bold">
        {track.album.name}
      </div>
      <div className="flex h-full flex-col gap-14 px-5 pt-36 pb-10">
        <div className="mx-auto mb-5 aspect-square max-w-[400px] bg-red-200">
          <img
        ...
        <div>
          ...
          <p className="text-text-dimmer">{track.artists[0].name}</p>
        </div>
