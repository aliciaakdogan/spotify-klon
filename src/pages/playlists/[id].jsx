    ...
    return (
      <Layout>
        ...
        <h2 className="px-4 py-16 text-center text-3xl font-bold md:text-5xl">
          Oops, could not get that playlist, try again later.
        </h2>{" "}
        <div className="flex justify-center">
          <Link href="/" className="rounded-full bg-primary px-6 py-4">
            Go back
          </Link>
        </div>
      </Layout>
          ...
          {isLoading
            ? Array(20)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="grid animate-pulse grid-cols-[auto_1fr_auto] items-center gap-4 py-1.5 px-6 text-sm hover:bg-text-dimmed/10  md:grid-cols-[auto_1fr_1fr_auto]"
                  >
                    <div className="w-8">
